 ...
 */
final class Version20250312105801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE projekt_id_id projekt_id_id INT DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE projekt_id_id projekt_id_id INT NOT NULL, CHANGE status status DATETIME DEFAULT NULL');
